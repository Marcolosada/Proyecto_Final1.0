                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="" name="titulo" id="titulo" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="ej: Acordeon pal examen de danice v:">
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(obj, function(i, value) {
                        $("#materias").append('<option value="' + value.id + '">' + value.name + '</option>');
                    });
                    $("#materias").show();
                    $(".xd").show();
                }
